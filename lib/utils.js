...
const fillDbLib = require('./fillDb.js');
...
function fillDb (options, callback) {
   logSectionInfo('fill database with setting data');
   var opts = _.merge(defaulOptions, options);
   fillDbLib.fillDb(opts, callback);
}
